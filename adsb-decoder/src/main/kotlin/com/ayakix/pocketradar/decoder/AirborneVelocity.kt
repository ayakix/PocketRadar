 ...
 *
 * Phase 1 supports the ground-speed subtypes (1 and 2) which cover all civil
 * subsonic and supersonic traffic. Subtypes 3 and 4 (airspeed-with-heading) are
 * left unsupported for now — they would yield a heading angle rather than a
 * track, so the calling code needs to handle them differently anyway.
 */
